...
<body>
	...
	<div class="slide-buttons">
        <!-- Slide buttons here -->
        <button class="slide-btn" onclick="gotoPage('version-1-course-x-lesson-12-page-1')">Slide 1</button>
        <button class="slide-btn" onclick="gotoPage('version-1-course-x-lesson-12-page-2')">Slide 2</button>
        <button class="slide-btn" onclick="gotoPage('version-1-course-x-lesson-12-page-3')">Slide 3</button>
        <button class="slide-btn" onclick="gotoPage('version-1-course-x-lesson-12-page-4')">Slide 4</button>
        <button class="slide-btn" onclick="gotoPage('version-1-course-x-lesson-12-page-5')">Slide 5</button>
        <button class="slide-btn" onclick="gotoPage('version-1-course-x-lesson-12-page-6')">Slide 6</button>
        <button class="slide-btn" onclick="gotoPage('version-1-course-x-lesson-12-page-7')">Slide 7</button>
        <button class="slide-btn" onclick="gotoPage('version-1-course-x-lesson-12-page-10')">Slide 8</button>
        <button class="slide-btn" onclick="gotoPage('version-1-course-x-lesson-12-page-11')">Slide 9</button>
        <button class="slide-btn" onclick="gotoPage('version-1-course-x-lesson-12-page-12')">Slide 10</button>
</div>
