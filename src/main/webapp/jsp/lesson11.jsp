...
<body>
	...
	<div class="slide-buttons">
        <!-- Slide buttons here -->
        <button class="btn btn-primary" onclick="gotoPage('version-1-course-x-lesson-11-page-1')">Slide 1</button></br></br>
        <button class="btn btn-primary" onclick="gotoPage('version-1-course-x-lesson-11-page-2')">Slide 2</button></br></br>
        <button class="btn btn-primary" onclick="gotoPage('version-1-course-x-lesson-11-page-3')">Slide 3</button></br></br>
        <button class="btn btn-primary" onclick="gotoPage('version-1-course-x-lesson-11-page-4')">Slide 4</button></br></br>
        <button class="btn btn-primary" onclick="gotoPage('version-1-course-x-lesson-11-page-5')">Slide 5</button></br></br>
        <button class="btn btn-primary" onclick="gotoPage('version-1-course-x-lesson-11-page-6')">Slide 6</button></br></br>
        <button class="btn btn-primary" onclick="gotoPage('version-1-course-x-lesson-11-page-7')">Slide 7</button></br></br>
        <button class="btn btn-primary" onclick="gotoPage('version-1-course-x-lesson-11-page-8')">Slide 8</button></br></br>
        <button class="btn btn-primary" onclick="gotoPage('version-1-course-x-lesson-11-page-9')">Slide 9</button></br></br>
        <button class="btn btn-primary" onclick="gotoPage('version-1-course-x-lesson-11-page-10')">Slide 10</button></br>
</div>
