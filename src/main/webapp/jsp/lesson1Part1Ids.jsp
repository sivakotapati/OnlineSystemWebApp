...
<body>
    ...
    <!-- Input for PDF file -->
    <input type="hidden" id="pdfUrl" value="../pdfs/Lesson1Part1Ids.pdf">
    ...
    <div class="d-flex justify-content-center mt-3">
        ...
        <button class="btn btn-primary ml-2" id="finishButton">Finish</button>
    </div>
                        ...
                        pdfjsLib.getDocument(pdfData).promise
                            .then(function (pdf) {
                                ...
                                finishButton.addEventListener("click", function () {
                                    // Show the first page of the PDF content
                                    showPage(1); //  first page is at index 1
                                });
